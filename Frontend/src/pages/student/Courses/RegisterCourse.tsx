...
type DisplayRow = {
  course: Course;
  section: Section | null; // trong TH chưa có lớp
};
...
const RegisterCoursePage: React.FC = () => {
  ...
  return (
    ...
    >
      {/* MENU OVERLAY giống trang trước nhưng nền trắng → menu đỏ */}
      {openMenu && (
        <div
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px 40px 16px" }}>
        ...
        >
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "1fr 3fr 2fr 1fr 1fr 1.5fr 1.2fr",
              fontWeight: 600,
              marginBottom: 18,
            }}
          >
          ...
          {data?.map(({ course, section }) => (
            ...
            >
              ...
              {section ? (
                <button
                  onClick={() =>
                    navigate(`/student/payment/${course.course_id}/${section.section_id}`)
                  }
                  style={{
